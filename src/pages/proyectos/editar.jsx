...
import { EDITAR_PROYECTO, ACTIVAR_ESTADO, TERMINAR_PROYECTO, PROBLEMA_PROYECTO, ACTIVAR_PROYECTO, EDITAR_OBJETIVO, REACTIVAR_PROYECTO} from "graphql/proyectos/mutations";
...
const EditarProyecto = () => {
  ...
  const [
    reActivarProyecto,
    {
      data: mutationDataReActivarProyecto,
      loading: mutationLoadingReActivarProyecto,
      error: mutationErrorReActivarProyecto,
    },
  ...
  const submitForm = (e) => {
    ...
    if (formData.estado === "ACTIVO" && formData.fase === "NULO") {
      ...
      reActivarProyecto({ variables: { _id } });
    }
  ...
  useEffect(() => {
    if (
      ...
      mutationErrorProyecto ||
      mutationErrorReActivarProyecto
    ) {
