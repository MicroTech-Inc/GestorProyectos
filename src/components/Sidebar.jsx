...
const SidebarLinks = () => {
  return (
    <ul className='mt-8'>
      ...
      <SidebarRoute to='/proyectos' title='Proyectos' icon='fas fa-cogs' />
      <SidebarRoute to='/avances' title='Avances' icon='far fa-copy' />
      <PrivateComponent roleList={['ADMINISTRADOR']}>
      <SidebarRoute to='/usuarios' title='Usuarios' icon='fas fa-user' />
      </PrivateComponent>      
      <SidebarRoute to='/perfil' title='Perfil' icon='far fa-user-circle' />
       <Logout />
    </ul>
  );
};
